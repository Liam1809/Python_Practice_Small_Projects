...
daily_transactions_split = [element.split(",") for element in daily_transactions]
#print(daily_transactions_split)
transactions_clean = [ele.strip(" ").strip("\n").strip() for element in daily_transactions_split for ele in element]
...
total_sales = 0
for sale in sales:
  total_sales += float(sale.strip("$"))//1
# print(total_sales)
# print(thread_sold)
thread_sold_split = []
thread_sold_split = [element.split("&") for element in thread_sold]
...
for color in colors:
  print("{} threads of {} were sold today".format(color_count(color), color))
